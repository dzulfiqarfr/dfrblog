...
Now, we can start converting the base figure, rounding it and writing it in a format that is easier to read. We will store the symbol of the currency output that we will use later. We also need to turn the long figures into units like million, billion, etc.
