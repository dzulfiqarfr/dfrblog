...
Kami tidak ingin mengklaim bahwa sampel kami representatif. Lagu unik dengan genre populer utama yang kami kumpulkan hanya 28.437 atau kira-kira kurang dari 0,001 persen dari total lagu yang tersedia di Spotify pada saat penulisan.

Kami tidak menggunakan semua genre populer utama, seperti *country*, latin atau funk. Kami juga tidak melakukan klasifikasi berdasarkan genre turunan atau yang berkaitan. Untuk konteks Indonesia, kami tidak memasukkan genre yang berkaitan dengan wilayah atau etnis tertentu, seperti lagu Batak.
